define([
  ...
  class InputNumberValueChangeChain1 extends ActionChain {
    ...
    async run(context, { event, previousValue, value, updatedFrom }) {
      ...
      if ($variables.custDetailsObj.bonus_rate && $variables.custDetailsObj.bonus_hours) {
        $variables.custDetailsObj.bonus_amount = $variables.custDetailsObj.bonus_rate * $variables.custDetailsObj.bonus_hours;
      } else {
