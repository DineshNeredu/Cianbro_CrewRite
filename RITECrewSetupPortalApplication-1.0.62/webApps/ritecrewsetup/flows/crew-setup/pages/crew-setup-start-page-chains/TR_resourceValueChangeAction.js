    ...
    async run(context, { value }) {
     ...
     //   $page.variables.linesObj.resource_location = '';
        ...
        if(response.ok){         
          ...
          const resouce = await $functions.getUniqueResources(response.body.items, $variables.linesObj.resource_name);

        $page.variables.linesObj.resource_number = resouce[0].resource_number;
        $page.variables.linesObj.resource_role = resouce[0].resource_job;
        $page.variables.linesObj.resource_location = resouce[0].resource_location;
        $page.variables.linesObj.project_assigned = resouce[0].project_assigned;
        $page.variables.linesObj.resource_id = resouce[0].resource_id;
         $page.variables.linesObj.assignment_number = resouce[0].assignment_number;
         $page.variables.linesObj.assignment_id = resouce[0].assignment_id;
