...
//$variables.linesObj.ot_threshold_limit =   response2.body.items.length > 0     ? response2.body.items[0].ot_threshold_limit  : "0";   $variables.minEffeDate = await $functions.effectiveDate(new Date());
