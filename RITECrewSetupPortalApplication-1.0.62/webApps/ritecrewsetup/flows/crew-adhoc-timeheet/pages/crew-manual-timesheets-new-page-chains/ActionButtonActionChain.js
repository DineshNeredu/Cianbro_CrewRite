define([
  ...
  class ActionButtonActionChain extends ActionChain {
    ...
    '$variables.selectedRow',
      ...
      // $variables.createObj.shift = current.row.shift;
      // $variables.createObj.emp_location = current.row.emp_location;
      // $variables.createObj.work_package = current.row.work_package;
      // $variables.createObj.department = current.row.department;
      // $variables.createObj.cost_center = current.row.cost_center;
      // $variables.createObj.id = current.row.id;
