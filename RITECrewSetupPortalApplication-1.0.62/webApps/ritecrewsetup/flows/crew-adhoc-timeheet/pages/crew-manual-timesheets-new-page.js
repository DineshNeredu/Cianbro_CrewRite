  ...
  class PageModule {
    ...
    columnsGenerator(headerParams, taskdata) {
      let array = [
        ...
        {
          headerText: 'Location/Tax Jurisdiction',
          field: 'emp_location'
        },
        {
          headerText: 'Work Package',
          field: 'work_package'
        },
        {
    ...
    createAdhocUITableADP(empRes, headerObj, taskdata, equiprest, newresource) {
      ...
      empRes.forEach((ele) => {
        let objTemp = {
          ...
          cost_center: headerObj.cost_center,
          department: headerObj.department,
          work_package: headerObj.work_package,
          emp_location: headerObj.emp_location,
          shift: headerObj.shift
        };
