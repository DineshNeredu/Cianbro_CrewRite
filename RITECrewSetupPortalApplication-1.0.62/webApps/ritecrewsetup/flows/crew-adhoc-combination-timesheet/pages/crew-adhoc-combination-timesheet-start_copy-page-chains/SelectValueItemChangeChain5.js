define([
  ...
  class SelectValueItemChangeChain5 extends ActionChain {
    ...
    '$variables.currentTaskObj',
      ...
      $variables.timeEntriesCustomObj.task_name = data.TaskName;
      $variables.timeEntriesCustomObj.task_id = data.TaskId;
      $variables.timeEntriesCustomObj.task_number = data.TaskNumber;
      $variables.timeEntriesCustomObj.task_date = data.TaskFinishDate;
    }
  }
