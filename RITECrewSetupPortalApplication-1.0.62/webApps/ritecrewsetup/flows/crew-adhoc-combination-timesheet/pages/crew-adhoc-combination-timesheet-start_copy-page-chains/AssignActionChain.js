...
debugger;
      ...
      await Actions.fireDataProviderEvent(context, {
        ...
        add: {
          ...
          keys: modifiedData.emptyArr.time_entry_id,
        },
      });
    ...
    async modifyData(context, { selectedEmpADP, timeEntriesADP, consolidationCurrentRow }) {
      ...
      selectedEmpADP.forEach(element => {
        ...
        let loopTImeEntryObj = {
          "time_entry_id": loopTimeEntryArr[0].resource_number + consolidationCurrentRow.combination_id + loopTimeEntryArr[0].crewsetup_line_id,
          "reference_time_entry_id": null,
          "timesheet_week_id": null,
          ...
          "supervisor_id": null,
          "person_id": loopTimeEntryArr[0].resource_number,
          ...
          "project_name": consolidationCurrentRow.project_name,
          "task_id": loopTimeEntryArr[0].task_id,
          "task_name": loopTimeEntryArr[0].task_name,
          "task_number": loopTimeEntryArr[0].task_number,
          ...
          "emp_location": consolidationCurrentRow.emp_location,
          "department": consolidationCurrentRow.department,
          "cost_center": consolidationCurrentRow.cost_center,
        ...
        //   "project_name": consolidationCurrentRow.project_name,
        //   "shift": consolidationCurrentRow.shift,
        //   "time_entry_id" : loopTimeEntryArr[0].resource_id + consolidationCurrentRow.combination_id + loopTimeEntryArr[0].crewsetup_line_id
        // };
